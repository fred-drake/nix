...
_: {
  "docker.gitea.com" = {
    ...
    "gitea" = {
      "1-rootless" = {
        "linux/amd64" = "docker.gitea.com/gitea@sha256:95b0ae18fb99b4a579b3dd383ea5ad8d8f77534c030c1fe554e6378ac8a5c496";
      };
    };
  };
  "docker.io" = {
    "actualbudget/actual-server" = {
      "latest" = {
        "linux/amd64" = "docker.io/actualbudget/actual-server@sha256:59cab86c77e764855119e2d5ddd96b9c9cefd90913f4feed7f4ee1433a6482c5";
      };
    };
    ...
    "apache/tika" = {
      "latest" = {
        "linux/amd64" = "docker.io/apache/tika@sha256:249c537cfe75ea76c59ef794653c8529fec9645efeffa4f87bed9ce56bf06a00";
      };
    };
  ...
  "ghcr.io" = {
    ...
    "linuxserver/prowlarr" = {
      "latest" = {
        "linux/amd64" = "ghcr.io/linuxserver/prowlarr@sha256:b5688a5a527b048c9f520f7a00941fceed1dd54c6f4b2b887b6fb4b3859a2109";
      };
    };
    "linuxserver/radarr" = {
      "latest" = {
    ...
    "linuxserver/sabnzbd" = {
      "latest" = {
        "linux/amd64" = "ghcr.io/linuxserver/sabnzbd@sha256:7302365720e54d49b584c5dc1928df3c3f7f9de8368ae307c36c22d8218e5860";
      };
    };
    "linuxserver/sonarr" = {
      "latest" = {
