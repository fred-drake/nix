/**
 * squash-and-push — pi command extension
 *
 * Registers /squash-and-push. Switches to openai-codex/gpt-5.6-luna, asks the
 * agent to squash unpushed work into a clean history and push it, then restores
 * the previous model when the agent turn ends.
 *
 * Usage:
 *   /squash-and-push
 */
...
const PROMPT =
  "Squash unpushed changes as necessary to ensure a clean commit history, then push.";
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerCommand("squash-and-push", {
    description:
      "Squash unpushed work into a clean history and push (via openai-codex/gpt-5.6-luna)",
