  ...
  services = {
    openssh = {
      ...
      settings = {
        ...
        PermitRootLogin = "no";
        ListenAddress = config.soft-secrets.host.paperless.admin_ip_address;
      };
    };
  };
  ...
  networking = {
    ...
    interfaces."eth0" = {
      ...
      ipv4 = {
        addresses = [
          {
            address = config.soft-secrets.host.paperless.admin_ip_address;
            prefixLength = 24;
          }
        ];
      };
    ...
    interfaces."eth0.50".ipv4 = {
      addresses = [
        {
          address = config.soft-secrets.host.paperless.service_ip_address;
          prefixLength = 24;
        }
      ];
      routes = [
