{
  ...
  services = {
    openssh = {
      ...
      settings = {
        ...
        PermitRootLogin = "no";
        ListenAddress = config.soft-secrets.host.radarr.admin_ip_address;
      };
    };
  ...
  fileSystems = {
    "/mnt/sabnzbd_downloads" = {
      device = "${config.soft-secrets.host.nas-nfs.service_ip_address}:/sabnzbd_downloads";
      fsType = "nfs";
      options = [
        "defaults"
        "nfsvers=4"
  ...
  networking = {
    ...
    interfaces."eth0" = {
      ...
      ipv4 = {
        addresses = [
          {
            address = config.soft-secrets.host.radarr.admin_ip_address;
            prefixLength = 24;
          }
        ];
      };
    ...
    interfaces."eth0.50".ipv4 = {
      addresses = [
        {
          address = config.soft-secrets.host.radarr.service_ip_address;
          prefixLength = 24;
        }
      ];
      routes = [
